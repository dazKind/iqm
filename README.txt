...
The "Left-handed Coords" will convert anything from blender's right handed coordinate system to left-handed coordinates. This is usefull for using iqm in 3d-engines that use left-handed coords(e.g. Opengl).
